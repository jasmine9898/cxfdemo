...
@WebServiceClient(name = "HelloWebServiceImplService", 
                  wsdlLocation = "http://localhost:8280/cxfdemo/services/HelloWebService?wsdl",
...
public class HelloWebServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:18080/cxfdemo/services/HelloWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWebServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:18080/cxfdemo/services/HelloWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
